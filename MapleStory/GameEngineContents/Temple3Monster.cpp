...
void Temple3Monster::Start()
{
	...
	mpRenderer->CreateFrameAnimationCutTexture("Temple3MonsterMove", FrameAnimation_DESC("Temple3MonsterMove.png", 0, 5, 0.2f));
	...
	mpRenderer->CreateFrameAnimationCutTexture("Temple3MonsterDie", FrameAnimation_DESC("Temple3MonsterDie.png", 0, 11, 0.2f, false));
	mpRenderer->CreateFrameAnimationCutTexture("Temple3MonsterAttack1", FrameAnimation_DESC("Temple3MonsterAttack1.png", 0, 16, 0.1f));
	mpRenderer->AnimationBindEnd("Temple3MonsterAttack1", std::bind(&Temple3Monster::EndAttack1, this));
	mpRenderer->CreateFrameAnimationCutTexture("Temple3MonsterAttack2", FrameAnimation_DESC("Temple3MonsterAttack2.png", 0, 16, 0.1f));
